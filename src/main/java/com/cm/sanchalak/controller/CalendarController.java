...
public class CalendarController {
    ...
    public ApiResult<List<CalendarEventDto>> getCalendarEvents(
        ...
        try {
            ...
            if (authorities.stream().anyMatch(auth -> auth.getAuthority().equals("ROLE_STUDENT"))) {
                ...
                events = calendarService.getCalendarEventsForStudent(student.getId(), currentUser.getId(), startDate,
                        endDate);
                ...
                events = calendarService.getCalendarEventsForParent(parent.getId(), currentUser.getId(), startDate,
                        endDate);
    ...
    /**
     * Get calendar events for a specific student (for parent viewing child's
     * calendar)
     */
    ...
    public ApiResult<List<CalendarEventDto>> getCalendarEventsForStudent(
        ...
        try {
            ...
            List<CalendarEventDto> events = calendarService.getCalendarEventsForStudent(
                    studentId, currentUser.getId(), startDate, endDate);
