...
/**
 * Refresh tokens for JWT authentication with family tracking for theft
 * detection.
...
public class RefreshToken {
    ...
    @JoinColumn(name = "user_id", nullable = false, columnDefinition = "BINARY(16)", foreignKey = @ForeignKey(name = "fk_refresh_token_user"))
    private User user;
