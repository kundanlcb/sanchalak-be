...
public class FeatureSeeder implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                logger.info("Checking master feature list...");
                ...
                List<Feature> masterFeatures = Arrays.asList(
                                ...
                                createFeature("TEACHER_MGMT", "Teacher Management",
                                                "Manage staff profiles, roles, and assignments."),
                                createFeature("ATTENDANCE", "Attendance Tracking",
                                                "Track daily student and staff attendance."),
                                createFeature("TIMETABLE", "Timetable Generation",
                                                "Create and manage academic schedules and timetables."),
                                createFeature("EXAM_MGMT", "Exam Management",
                                                "Define exams, record marks, and generate report cards."),
                                createFeature("FINANCE", "Finance & Payroll",
                                                "Manage fees, expenses, employee payroll, and financial reports."),
                                createFeature("LIBRARY", "Library Management",
                                                "Track books, issuances, returns, and library fines."),
                                createFeature("TRANSPORT", "Transport Management",
                                                "Manage vehicle routes, stops, and transport assignments."),
                                createFeature("HOSTEL", "Hostel Management",
                                                "Manage hostel rooms, allocation, and boarding details."),
                                createFeature("COMMUNICATION", "Communication (SMS/Email)",
                                                "Broadcast messages, notifications, and alerts."),
                                createFeature("MOBILE_APP", "Mobile App Access",
                                                "Enable access to the companion mobile application."),
                                createFeature("ANALYTICS", "Analytics Dashboard",
                                                "Access advanced reporting and school analytics."),
                                createFeature("PRIORITY_SUPPORT", "Priority Support",
                                                "24/7 priority customer support for the institution."));

                int addedCount = 0;
                for (Feature feature : masterFeatures) {
                ...
                if (addedCount > 0) {
                        logger.info("Successfully seeded {} new features.", addedCount);
                } else {
