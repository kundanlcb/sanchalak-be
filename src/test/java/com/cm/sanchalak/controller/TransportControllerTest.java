...
class TransportControllerTest {
    ...
    void testGetMyRoute_Student() throws Exception {
        ...
        UserPrincipal principal = new UserPrincipal(userId, "Student Name", "student", "student@example.com", "password", 
                Collections.singletonList(new SimpleGrantedAuthority("ROLE_STUDENT")));
        
        // Setup Standalone MockMvc with a custom ArgumentResolver to inject our principal
        ...
        // Ensure active status if needed, though controller doesn't seem to check it explicitly yet
